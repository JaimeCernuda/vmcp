...
class MockMCPServer:
    ...
    async def _execute_mock_tool(self, tool_name: str, arguments: dict[str, Any]) -> str:
    ...
    async def _handle_resources_subscribe(self, request_id: Any, params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_resources_unsubscribe(self, request_id: Any, params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_completion_complete(self, request_id: Any, params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_mock_method(self, request_id: Any, method: str, params: dict[str, Any]) -> dict[str, Any]:
...
async def run_mock_server_cli() -> None:
    ...
    parser.add_argument("--simulate-errors", action="store_true", help="Simulate random errors")
    parser.add_argument("--error-rate", type=float, default=0.1, help="Error rate (0.0-1.0)")
    parser.add_argument("--response-delay", type=float, default=0.0, help="Response delay in seconds")
