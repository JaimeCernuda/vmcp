...
from vmcp.registry.registry import ServerRegistry, ServerInfo, ServerState
...
class TestServerRegistry:
    ...
    def test_list_servers(self, registry):
        ...
        server1 = ServerInfo(id="server1", name="Server 1", transport="stdio", command="python", args=[])
        server2 = ServerInfo(id="server2", name="Server 2", transport="http", command="node", args=[])
    ...
    def test_list_servers_by_status(self, registry):
        ...
        server1 = ServerInfo(id="server1", name="Server 1", transport="stdio", command="python", args=[])
        server2 = ServerInfo(id="server2", name="Server 2", transport="stdio", command="python", args=[])
    ...
    def test_get_enabled_servers(self, registry):
        ...
        server1 = ServerInfo(id="server1", name="Server 1", transport="stdio", command="python", args=[], enabled=True)
        server2 = ServerInfo(id="server2", name="Server 2", transport="stdio", command="python", args=[], enabled=False)
